...
import { ArrowUp, ArrowDown, ArrowLeft, ArrowRight, Home, Settings } from "lucide-react"
...
export function MotorControl() {
  ...
  const moveMotor = (axis: keyof MotorPositions, direction: number, distance = 1) => {
    setPositions((prev) => ({
      ...prev,
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2 w-32 mx-auto">
            <div></div>
            <Button variant="outline" size="icon" onClick={() => moveMotor("y", 1)}>
              <ArrowUp className="w-4 h-4" />
            </Button>
            <div></div>
            <Button variant="outline" size="icon" onClick={() => moveMotor("x", -1)}>
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-center space-x-2">
            <Button variant="outline" size="sm" onClick={() => moveMotor("z", 1)}>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <h4 className="font-medium text-sm text-gray-700">Syringe</h4>
            <div className="space-y-1">
              <Button
                variant="outline"
                size="sm"
                className="w-full bg-transparent"
                onClick={() => moveMotor("syringe", 1, 2)}
              >
                Push +2mm
              </Button>
              <Button
